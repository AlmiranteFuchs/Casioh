...
class CommandsController {
    ...
    public async Run_command(user_access_level: number, params: params_to_command): Promise<void> {
        ...
        if (command) {
            let command_result = await command.Exec_command(user_access_level, params);
